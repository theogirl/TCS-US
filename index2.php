...
<div class="container">
	<section class="row tcs-promos">
	    ...
	    <div class="promo_banner">HOLIDAY SPECIAL</div>
	      <img src="images/feature-dec2.jpg" alt="Holiday Promo: Save 5% on Glassware!">
	      <div class="caption">
	        <h3><span style="color: rgb(117,15,92);">Save 5% on New Orders of Glassware!</span></h3>
	        <p>Toast the season with blank or printed glasses that add to the festive spirit, while promoting your brand or message! Check out our full line of <a href="http://www.thecupstore.com/prod-glassware.php">glassware</a> that includes stemware, beer steins and barware.</p>
	      </div>
	    </div>
	  </div>
